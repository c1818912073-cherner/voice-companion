...
仓库自带脚本，可从[维基文库](https://zh.wikisource.org)一键下载**公有领域**经典全文并放入书架（全部已进公有领域，可自由使用）：

**四大名著**：《红楼梦》《三国演义》《西游记》《水浒传》（120回本）

**特色书目**：
| 书 | 特色 |
|---|---|
| 《老残游记》 | 晚清旅行见闻，"白妞说书"一段对白如临其境 |
| 《官场现形记》 | 60 回官场讽刺群像，对话密集，角色朗读效果拉满 |
| 《儒林外史》 | 范进中举出处，士林群像讽刺 |
| 《聊斋志异》 | 12 卷志怪短篇，一故事一世界 |

```bash
python3 tools/fetch_classics.py            # 抓全部（断点续抓，遇限速自动退避）
python3 tools/fetch_classics.py 聊斋       # 只抓某本（简繁书名均可）
```
